...
EOF
 ...
 2)  
  ...
  rm -rf update-*.sh openwrt_*
  url=https://mirror.ghproxy.com/https://github.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/releases/download/openwrt_n1
  Firmware=openwrt_s905d_n1_R21.12.1_k5.10.84-kissyouhunter-docker.img.gz
  img=openwrt_s905d_n1_R21.12.1_k5.10.84-kissyouhunter-docker.img
  echo "====下载固件中(需科学上网,否则无法更新)===="
  curl -LO $url/$Firmware
  wget https://mirror.ghproxy.com/https://raw.githubusercontent.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/main/update-N1-openwrt.sh
  echo "=============下载完成,解压中=============="
 ...
 3) 
  ...
  rm -rf update-*.sh openwrt_*
  url=https://mirror.ghproxy.com/https://github.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/releases/download/openwrt_n1
  Firmware=openwrt_s905d_n1_R21.12.1_k5.4.164-kissyouhunter-docker.img.gz
  img=openwrt_s905d_n1_R21.12.1_k5.4.164-kissyouhunter-docker.img
  echo "====下载固件中(需科学上网,否则无法更新)===="
  curl -LO $url/$Firmware
  wget https://mirror.ghproxy.com/https://raw.githubusercontent.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/main/update-N1-openwrt.sh
  echo "=============下载完成,解压中=============="
 ...
 4) 
  ...
  rm -rf update-*.sh openwrt_*
  url=https://mirror.ghproxy.com/https://github.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/releases/download/openwrt_n1
  Firmware=openwrt_s905d_n1_R21.12.1_k5.15.7-kissyouhunter-docker.img.gz
  img=openwrt_s905d_n1_R21.12.1_k5.15.7-kissyouhunter-docker.img
  echo "====下载固件中(需科学上网,否则无法更新)===="
  curl -LO $url/$Firmware
  wget https://mirror.ghproxy.com/https://raw.githubusercontent.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/main/update-N1-openwrt.sh
  echo "=============下载完成,解压中=============="
