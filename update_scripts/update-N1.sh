...
TIME g "---------------------------------------"
TIME b "(1) 更新至内核 5.4.192  版本 到EMMC"
TIME y "(2) 更新至内核 5.10.114 版本 到EMMC"
TIME z "(3) 更新至内核 5.15.38  版本 到EMMC"
TIME w "(4) 更新至内核 5.17.6   版本 到EMMC"
TIME l "(0) 返回上级菜单"

 read -p "Please enter your choice[0-4]: " input1
 case $input1 in 
 1)
  TIME g " >>>>>>>>>>>更新至内核 5.4.192 版本 到EMMC开始"
  cd /mnt/mmcblk2p4
  ...
  Firmware=openwrt_s905d_n1_R22.5.5_k5.4.192-kissyouhunter.img.gz
  img=openwrt_s905d_n1_R22.5.5_k5.4.192-kissyouhunter.img
  TIME g "==========下载固件中==========="
  TIME r "====需科学上网,否则无法更新===="
  ...
  ;;
 2)  
  TIME g " >>>>>>>>>>>更新至内核 5.10.114 版本 到EMMC开始"
  cd /mnt/mmcblk2p4
  rm -rf update-*.sh openwrt_*
  url=https://mirror.ghproxy.com/https://github.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/releases/download/openwrt_n1
  Firmware=openwrt_s905d_n1_R22.5.5_k5.10.114-kissyouhunter.img.gz
  img=openwrt_s905d_n1_R22.5.5_k5.10.114-kissyouhunter.img
  TIME g "==========下载固件中==========="
  TIME r "====需科学上网,否则无法更新===="
  curl -LO $url/$Firmware
  wget https://mirror.ghproxy.com/https://raw.githubusercontent.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/main/update-N1-openwrt.sh
  ...
  ;;
 3) 
  TIME g " >>>>>>>>>>>更新至内核 5.15.38 版本 到EMMC开始"
  cd /mnt/mmcblk2p4
  rm -rf update-*.sh openwrt_*
  url=https://mirror.ghproxy.com/https://github.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/releases/download/openwrt_n1
  Firmware=openwrt_s905d_n1_R22.5.5_k5.15.38-kissyouhunter.img.gz
  img=openwrt_s905d_n1_R22.5.5_k5.15.38-kissyouhunter.img
  TIME g "==========下载固件中==========="
  TIME r "====需科学上网,否则无法更新===="
  curl -LO $url/$Firmware
  wget https://mirror.ghproxy.com/https://raw.githubusercontent.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/main/update-N1-openwrt.sh
 ...
 946574) 
  ...
  ;;
 4) 
  TIME g " >>>>>>>>>>>更新至内核 5.17.6 版本 到EMMC开始"
  cd /mnt/mmcblk2p4
  rm -rf update-*.sh openwrt_*
  url=https://mirror.ghproxy.com/https://github.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/releases/download/openwrt_n1
  Firmware=openwrt_s905d_n1_R22.5.5_k5.17.6-kissyouhunter.img.gz
  img=openwrt_s905d_n1_R22.5.5_k5.17.6-kissyouhunter.img
  TIME g "==========下载固件中==========="
  TIME r "====需科学上网,否则无法更新===="
  curl -LO $url/$Firmware
  wget https://mirror.ghproxy.com/https://raw.githubusercontent.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/main/update-N1-openwrt.sh
...
TIME l "(0) 返回上级菜单"
 ...
 1)
  ...
  ;;
 2)
  TIME g " >>>>>>>>>>>更新至内核 5.10.114 版本 到U盘开始"
  cd /mnt/sda4
  rm -rf update-*.sh openwrt_*
  url=https://mirror.ghproxy.com/https://github.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/releases/download/openwrt_n1
  Firmware=openwrt_s905d_n1_R22.5.5_k5.10.114-kissyouhunter.img.gz
