...
(2) 更新至内核 5.10.87 版本 到EMMC
(3) 更新至内核 5.4.167 版本 到EMMC
(4) 更新至内核 5.15.10  版本 到EMMC
(0) 返回上级菜单
EOF
 ...
 1)
  ...
  ;;
 2)  
  echo -e " >>>>>>>>>>>更新至内核 5.10.87 版本 到EMMC开始"
  cd /mnt/mmcblk2p4
  rm -rf update-*.sh openwrt_*
  url=https://mirror.ghproxy.com/https://github.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/releases/download/openwrt_n1
  ...
  ;;
 3) 
  echo -e " >>>>>>>>>>>更新至内核 5.4.167 版本 到EMMC开始"
  cd /mnt/mmcblk2p4
  rm -rf update-*.sh openwrt_*
  url=https://mirror.ghproxy.com/https://github.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/releases/download/openwrt_n1
  ...
  ;;
 4) 
  echo -e " >>>>>>>>>>>更新至内核 5.15.10 版本 到EMMC开始"
  cd /mnt/mmcblk2p4
  rm -rf update-*.sh openwrt_*
  url=https://mirror.ghproxy.com/https://github.com/kissyouhunter/Openwrt_X86-Openwrt_N1-Armbian_N1/releases/download/openwrt_n1
...
(2) 更新至内核 5.10.87 版本 到U盘
(3) 更新至内核 5.4.167 版本 到U盘
(4) 更新至内核 5.15.10  版本 到U盘
(0) 返回上级菜单
EOF
