...
----------------------------------------
(1) 更新至内核 5.14.14 版本 到EMMC
(2) 更新至内核 5.10.75 版本 到EMMC
(3) 更新至内核 5.4.155 版本 到EMMC
(0) 返回上级菜单
EOF
 read -p "Please enter your choice[0-3]: " input1
 case $input1 in 
 1)
  echo -e " >>>>>>>>>>>更新至内核 5.14.14 版本 到EMMC开始"
  cd /mnt/mmcblk2p4
...
|****Please Enter Your Choice:[0-3]****|
----------------------------------------
(1) 更新至内核 5.14.14 版本 到U盘
(2) 更新至内核 5.10.75 版本 到U盘
(3) 更新至内核 5.4.155 版本 到U盘
(0) 返回上级菜单
EOF
